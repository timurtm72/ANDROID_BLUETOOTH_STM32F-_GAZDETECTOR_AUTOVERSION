#line 1 "D:/ALL_PROJECTS/GAZ_DETECTOR/UZCAR_STM32F0/UZCAR_STM32F031_MC101_BTU/eeprom_func.c"
...
#line 3 "D:/ALL_PROJECTS/GAZ_DETECTOR/UZCAR_STM32F0/UZCAR_STM32F031_MC101_BTU/eeprom_func.c"
unsigned long ADDRESS = 0x08007400;
...
void ChekTrue()
{
 save_data_to_eeprom_one(ADDRESS2, 200 ,&flag_t.enable_status);
...
char FLASH_ReadOutProtection(unsigned char new_state)
 ...
 FLASH_OPTKEYR =  (( unsigned long )0x45670123)  ;
 FLASH_OPTKEYR =  (( unsigned long )0xCDEF89AB)  ;

 FLASH_CR |=  (( unsigned long )0x00000020) ;
 FLASH_CR |=  (( unsigned long )0x00000040) ;
 ...
 FLASH_CR |=  (( unsigned long )0x00000010) ;
 if(new_state ==  1 )
 {
 LEVEL1_PROT_bit =  1 ;
 LEVEL2_PROT_bit =  0 ;
...
#line 198 "D:/ALL_PROJECTS/GAZ_DETECTOR/UZCAR_STM32F0/UZCAR_STM32F031_MC101_BTU/eeprom_func.c"
char FLASH_WaitForLastOperation()
{
#line 204 "D:/ALL_PROJECTS/GAZ_DETECTOR/UZCAR_STM32F0/UZCAR_STM32F031_MC101_BTU/eeprom_func.c"
 while ((FLASH_SR &  (( unsigned long )0x00000001) ) != 0)
 {

 }


 if((FLASH_SR &  (( unsigned long )0x00000020) ) ==  0 )
 {
 FLASH_SR |=  (( unsigned long )0x00000020) ;
 }
 if((FLASH_SR &  (( unsigned long )0x00000010) ) || (FLASH_SR &  (( unsigned long )0x00000004) ))
 {
 return -1;
...
char FLASH_GetReadOutProtectionStatus()
 {
 if ((LEVEL1_PROT_bit ==  0 )&&(LEVEL2_PROT_bit ==  0 ))
 {
 return  0 ;
 }
 else
